...
export default function ColorEnhancer() {
    ...
    const handleResultGenerate = (value) => {
        setEnhanceColors(value);
    } 
                    ...
                    <Row className="justify-content-center text-center">
                        ...
                        <ColorSampleCard bgColor={bgColor} fgColor={fgColor} cardTitle="Original Color Sample" contrastRatio={getContrastRatio(convertHexToRGBArray(fgColor), convertHexToRGBArray(bgColor))}/>                            
                            <Result bgColor={bgColor}
                                ...
                                onGenerate={handleResultGenerate}
                                currentBGColor={currentBGColor}
                                currentFGColor={currentFGColor}
                                bgSliderValue={bgSliderValue}
                                fgSliderValue={fgSliderValue}
                                handleBGSliderChange={handleBGSliderChange}
                                handleFGSliderChange={handleFGSliderChange}
                            />
                        </Container>
                    </Row>
                </Col>
